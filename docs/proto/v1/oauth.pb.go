...
type User struct {
	...
	Id         uint64                 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                                  // Go: uint
	ProviderId string                 `protobuf:"bytes,2,opt,name=provider_id,json=providerId,proto3" json:"provider_id,omitempty"` // Go: string
	Provider   string                 `protobuf:"bytes,3,opt,name=provider,proto3" json:"provider,omitempty"`                       // Go: string
	Name       string                 `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty"`                               // Go: string
	Email      string                 `protobuf:"bytes,5,opt,name=email,proto3" json:"email,omitempty"`                             // Go: string
	Picture    string                 `protobuf:"bytes,6,opt,name=picture,proto3" json:"picture,omitempty"`                         // Go: string
	CreatedAt  *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`    // Go: time.Time
	UpdatedAt  *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`    // Go: time.Time
	DeletedAt  *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=deleted_at,json=deletedAt,proto3" json:"deleted_at,omitempty"`    // Go: gorm.DeletedAt
}
...
var file_oauth_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x6f, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x67,
	0x72, 0x70, 0x63, 0x2e, 0x76, 0x31, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d,
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x26, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x55, 0x73,
	...
	0x32, 0x0d, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52,
	0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0xc8, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e,
	...
	0x32, 0x45, 0x0a, 0x05, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x12, 0x3c, 0x0a, 0x07, 0x47, 0x65, 0x74,
	0x55, 0x73, 0x65, 0x72, 0x12, 0x17, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x76, 0x31, 0x2e, 0x47,
	0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e,
	0x67, 0x72, 0x70, 0x63, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0f, 0x5a, 0x0d, 0x64, 0x6f, 0x63, 0x73, 0x2f,
...
var file_oauth_proto_goTypes = []interface{}{
	(*GetUserRequest)(nil),        // 0: grpc.v1.GetUserRequest
	(*GetUserResponse)(nil),       // 1: grpc.v1.GetUserResponse
	(*User)(nil),                  // 2: grpc.v1.User
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_oauth_proto_depIdxs = []int32{
	2, // 0: grpc.v1.GetUserResponse.user:type_name -> grpc.v1.User
	3, // 1: grpc.v1.User.created_at:type_name -> google.protobuf.Timestamp
	3, // 2: grpc.v1.User.updated_at:type_name -> google.protobuf.Timestamp
	3, // 3: grpc.v1.User.deleted_at:type_name -> google.protobuf.Timestamp
	0, // 4: grpc.v1.OAuth.GetUser:input_type -> grpc.v1.GetUserRequest
	1, // 5: grpc.v1.OAuth.GetUser:output_type -> grpc.v1.GetUserResponse
